...
public class FireSword2 extends ItemSword implements IHasModel
{
	private double damage;
	private double speed;
	
	public FireSword2(String name, ToolMaterial material, double speed, double damage) 
	{
		super(material);
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		if(GameSettings.isKeyDown(key))
		{
			...
			tooltip.add("§3伤害: §7中");
			tooltip.add("§3攻速: §a快");
			tooltip.add("§3效果: §a手持可以防火,使敌人灼烧15秒");
			tooltip.add("§7=================================");
			tooltip.add("§e火焰石修复");
		}else
		{
	...
	public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
		...
		if(isSelected)
		{
			if(entityIn instanceof EntityPlayer)
			{
				...
				player.addPotionEffect(new PotionEffect(Potion.getPotionById(12), 15*20, 0));
			}
		}
	}
